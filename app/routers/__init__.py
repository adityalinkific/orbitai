...
from app.modules.meeting.meeting_routers import router as meeting_router, attendee_router as meeting_attendee_router
...
api_router.include_router(meeting_attendee_router)